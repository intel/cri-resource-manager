...
func TestOverwrite(t *testing.T) {
	...
	ads.Overwrite(NewAddrData(10*PS, 10, 1))
	expectLen(1)
	expectDataOk(0, 0, false)
	...
	ads.Overwrite(NewAddrData(5*PS, 2, 2))
	expectLen(2)
	...
	ads.Overwrite(NewAddrData(25*PS, 4, 3))
	expectLen(3)
	expectDataOk(19*PS, 1, true)
	expectDataOk(20*PS, 0, false)
	expectDataOk(21*PS, 0, false)
	...
	ads.Overwrite(NewAddrData(26*PS, 1, 4))
	expectLen(5)
	expectDataOk(24*PS, 0, false)
	expectDataOk(25*PS, 3, true)
	...
	ads.Overwrite(NewAddrData(3*PS, 5, 5))
	expectLen(5)
	...
	ads.Overwrite(NewAddrData(8*PS, 2, 6))
	expectLen(6)
	expectDataOk(7*PS, 5, true)
	...
	ads.Overwrite(NewAddrData(1*PS, 3, 7))
	expectLen(7)
	...
	ads.Overwrite(NewAddrData(28*PS, 2, 8))
	expectLen(8)
	expectDataOk(24*PS, 0, false)
	expectDataOk(25*PS, 3, true)
	expectDataOk(26*PS, 4, true)
	...
	ads.Overwrite(NewAddrData(8*PS, 2, 9))
	expectLen(8)
	expectDataOk(7*PS, 5, true)
	...
	ads.Overwrite(NewAddrData(25*PS, 3, 10))
	...
	ads.Overwrite(NewAddrData(24*PS, 5, 11))
	...
	ads.Overwrite(NewAddrData(18*PS, 7, 12))
	expectLen(7)
	...
	ads.Overwrite(NewAddrData(2*PS, 27, 13))
	expectLen(3)
	expectDataOk(0*PS, 0, false)
	expectDataOk(1*PS, 7, true)
	...
	ads.Overwrite(NewAddrData(1*PS, 29, 14))
	expectLen(1)
	expectDataOk(0*PS, 0, false)
